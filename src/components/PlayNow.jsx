...
//     } else {
//       SetScore((prev) => prev - 2); // Deduct 2 points for incorrect guess
//     }
...
//         {rulesPage ? < Rules toggle = {toggleRulesPage}/> : <PlayNow toggle ={toggleRulesPage}/>}

//       <btn onClick={toggle}>Show rules</btn>
//         {/* <Btn onClick={() => setShowRules((prev) => !prev)}>
